    ...
    return (
        <div data-aos="fade-up">
            <div className="text-center px-4">
                <h2 className='text-orange-300 xs:text-xl sm:text-2xl md:text-3xl lg:text-4xl mt-10'>Our Devs</h2>
            ...
            <div className='flex gap-10 xs:flex-col xl:flex-row justify-center items-center mx-10'>
                <div className='flex flex-col justify-center items-center text-center gap-4 mt-5'>
                    <img src='https://i.ibb.co/cNxgFQB/scientist.png' className='xs:max-w-[50%] sm:max-w-[20%] md:max-w-[20%] lg:max-w-[22%] xl:max-w-[30%]'/>
                    <h3 className='max-w-md text-orange-300 xs:text-lg sm:text-xl md:text-2xl'>Mad Scientist Drake</h3>
                ...
                <div className='flex flex-col justify-center items-center text-center gap-4'>
                    ...
                    <h3 className='max-w-md text-orange-300 xs:text-lg sm:text-xl md:text-2xl'>Admiral Starburns</h3>
                ...
                <div className='flex flex-col justify-center items-center text-center gap-4'>
                    ...
                    <h3 className='max-w-md text-orange-300 xs:text-lg sm:text-xl md:text-2xl'>Flight Commander Penguin</h3>
