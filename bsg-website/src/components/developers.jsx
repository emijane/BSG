        ...
        <div>
            ...
            <div className='flex gap-10 xs:flex-col xl:flex-row justify-center items-center mx-10'>
                <div className='flex flex-col justify-center items-center text-center gap-6 mt-5'>
                    <img src='./src/images/scientist.png' className='xs:max-w-[50%] sm:max-w-[20%] md:max-w-[20%] lg:max-w-[22%] xl:max-w-[30%]'/>
                ...
                <div className='flex flex-col justify-center items-center text-center gap-6'>
                    <img src='./src/images/admiral.png' className='xs:max-w-[50%] sm:max-w-[20%] md:max-w-[20%] lg:max-w-[22%] xl:max-w-[30%]'/>
                ...
                <div className='flex flex-col justify-center items-center text-center gap-6'>
                    <img src='./src/images/commander.png' className='xs:max-w-[50%] sm:max-w-[20%] md:max-w-[20%] lg:max-w-[22%] xl:max-w-[30%]'/>
