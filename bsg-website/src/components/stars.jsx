...
function Stars () {
    return (
        <div className="relative mt-[-1px]">
            {/* Stars background */}
            <div className="bg-stars bg-cover bg-center relative z-0 bg-repeat flex flex-col justify-center items-center gap-20 min-h-screen">
                ...
                <Video/>
                <div className='flex flex-col gap-20 mt-20 xl:max-w-[75%] lg:max-w-[100%] sm:max-w-[100%] px-10'>
                    <ImageComponent
